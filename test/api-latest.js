...
test('vault.readdir', async t => {
  var vault = new DPackVault(testStaticDPackURL, {dpackOptions: {latest: true}, localPath: tempy.directory()})
...
test('vault.readFile', async t => {
  ...
  var badVault = new DPackVault(fakeDPackURL, {dpackOptions: {latest: true}, localPath: tempy.directory()})
...
test('vault.createFileActivityStream', async t => {
  ...
  var vault = await DPackVault.create({dpackOptions: {latest: true}, localPath: tempy.directory(), title: 'Another Test DPack'})
...
test('vault.createNetworkActivityStream', async t => {
  ...
  var vault = new DPackVault(testStaticDPack2URL, {dpackOptions: {latest: true}, localPath: tempy.directory()})
  await vault._loadPromise
